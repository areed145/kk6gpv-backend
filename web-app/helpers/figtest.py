...
df_thp = df_thp.drop_duplicates(subset=['temp_f', 'relative_humidity'], keep='first')
...
test = pd.pivot_table(df_thp, values='pressure_in', index=['temp_f'], columns=['relative_humidity'], aggfunc=np.mean)
test.shape
